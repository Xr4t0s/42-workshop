module social::social {
	...
	/*
		...
		profiles: 		adresse du registre des profils
		username: 		nom d'utilisateur à la création
		description: 	bio / description du profil créé
	...
	*/
	...
	/**/
	/*
		Fonction de création de profil avec avatar

		profiles: 		adresse du registre des profils
		username: 		nom d'utilisateur à la création
		description: 	bio / description du profil créé
		avatar_url: 	URL IPFS de l'avatar (ex: upload via PINATA)
		ctx: 			contexte de transaction
	*/
	/**/	#[allow(lint(self_transfer))]
	...
	/**/
	/*
		Fonction de mise à jour de l'URL d'avatar

		p: 			référence mutable vers l'objet Profile à modifier
		new_url: 	nouvelle URL d'avatar
		_ctx: 		contexte (non utilisé ici)
	*/
	...
	/*
		...
		reg: 					adresse du registre des followers
		follower_profile: 		objet Profile du follower (appelant)
		followed_profile_id: 	adresse du profil suivi
		ctx: 					contexte de transaction
	*/
	/**/	#[allow(lint(self_transfer))]
    /**/	public fun follow(
	...
	/**/
	/*
		Fonction de unfollow

		reg: 					adresse du registre des followers
		follower_profile: 		objet Profile du follower
		nft:				 	objet Follow minté lors du follow
		_ctx: 					contexte (non utilisé ici)
	*/
    /**/	public fun unfollow(
    /**/	    reg: &mut FollowersRegistry,
	...
	/**/
	/*
		Fonction de publication de post

		posts: 			adresse du registre des posts
		author_profile:	objet Profile de l'auteur
		content: 		contenu texte du post
		clock: 			référence vers l'horloge on-chain (timestamp)
		ctx: 			contexte de transaction
	*/
	/**/	#[allow(lint(self_transfer))]
	...
	/**/
	/*
		Fonction d'édition de post

		author_profile:	objet Profile de l'auteur (doit posséder le post)
		post: 			référence mutable vers l'objet Post à modifier
		new_content:	nouveau contenu texte du post
		clock: 			référence vers l'horloge on-chain
		ctx: 			contexte de transaction
	*/
	...
	/*
		...
		posts: 			adresse du registre des posts
		author_profile:	objet Profile de l'auteur
		post: 			objet Post consommé (sera détruit)
	*/
	...
	/*
		...
		likes: 			adresse du registre global des likes
		liker_profile:	objet Profile du liker
		post_id:		adresse de l'objet Post liké
		ctx: 			contexte de transaction
	*/
	/**/	#[allow(lint(self_transfer))]
	...
	/**/
	/**/		// Empêche de liker deux fois le même post avec le même wallet
	...
	/**/		};
	/**/
	/**/		// Index logique (post, liker) -> id du NFT de like
	...
	/**/
	/*
		Fonction d'unlike d'un post

		likes: 			adresse du registre global des likes
		liker_profile:	objet Profile du liker
		like_nft:		objet Like (NFT) à brûler
	*/
	...
	/*
		...
		comments: 		adresse du registre global des commentaires
		author_profile:	objet Profile de l'auteur du commentaire
		post_id:		adresse de l'objet Post commenté
		content:		contenu texte du commentaire
		clock:			référence vers l'horloge on-chain
		ctx:			contexte de transaction
	*/
	...
	/*
		...
		author_profile:	objet Profile de l'auteur du commentaire
		comment:		référence mutable vers l'objet Comment
		new_content:	nouveau contenu texte
		clock:			référence vers l'horloge on-chain
		ctx:			contexte de transaction
	*/
	...
	/*
		...
		comments: 		adresse du registre global des commentaires
		author_profile:	objet Profile de l'auteur
		comment:		objet Comment consommé (sera détruit)
	*/
	...
	/**/
	/*
		Vérifie si un profil suit une adresse de profil donnée

		p: 		objet Profile
		who:	adresse de profil à tester
	*/
    public fun is_following(p: &Profile, who: address): bool {
        utils::contains_addr(&p.followed, who)
    }

	/*
		Retourne le nombre de followers on-chain d'un profil

		reg: 		registre global des followers
		profile_id:	adresse du profil
	*/
	...
	/*
		Retourne le nombre de profils suivis localement par un profil
	...
	*/
	...
	/*
		Retourne le nombre de likes d'un post

		reg: 		registre global des likes
		post_id:	adresse du post
	*/
	...
	/*
		Retourne le nombre de commentaires d'un post

		reg: 		registre global des commentaires
		post_id:	adresse du post
	*/
	...
	/*
		Retourne le nombre de posts d'un profil

		reg: 		registre global des posts
		profile_id:	adresse du profil
	*/
